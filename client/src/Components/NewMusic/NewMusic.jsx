...
import { newMusicPlatform } from '../../helper/api'
...
function NewMusic() {
  ...
  const handleNewMusic = async (e) => {
      e.preventDefault()
      try {
          setIsLoading(true)
          console.log(formData)
          const res = await newMusicPlatform(formData)
      } catch (error) {
          console.log('Unable to create new music app::', error)
      } finally {
          setIsLoading(false)
      }
  }
  ...
  return (
    <form className='newMusic' onSubmit={handleNewMusic}>
        ...
        <div className="submitBtn">
            <button onClick={handleNewMusic} disabled={isLoading} >
