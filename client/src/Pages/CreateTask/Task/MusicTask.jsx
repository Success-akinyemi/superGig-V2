...
import { useFetchAllMusicPlatform, useFetchMusicTask } from '../../../hooks/fetch.hooks';
...
function MusicTask({ content, setContent }) {
    ...
    const socialMediaData = musicPlatformData?.data
    //console.log(socialMediaData)
    const { isLoadingMusicTaskData, musicTaskData } = useFetchMusicTask()
    const socialMediaTask = musicTaskData?.data
